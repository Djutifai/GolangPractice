...
type GetLogMessage struct {
	Logs string `json:"requests"`
}
...
func (m *GetLogMessage) CreateLogMessage(query interface{}) {
	m.Logs = fmt.Sprintf("%v", query)
}
